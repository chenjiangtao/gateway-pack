 ...
 * 
 * @author liuzhenxing
 * @version $Id: SMGPGatewayProxyFactory.java, v 0.1 2012-5-28 下午3:22:20 liuzhenxing Exp $
 */
public class SMGPGatewayProxyFactory extends PGatewayProxyFactory {
    ...
    public GatewayProxy createGatewayProxy(Map<String, String> params) {
        SMGPSMProxy proxy = new SMGPSMProxy(params);
        return proxy;
    }
    ...
    public GatewayProxy createGatewayProxy(String id, Map<String, String> params) {
        SMGPSMProxy proxy = new SMGPSMProxy(id, params);
        return proxy;
    }
