...
public class SMGP3SubmitRespMessage extends SMGP3Message
{

    public SMGP3SubmitRespMessage(byte buf[])
    ...
    public String getMsgIdStr() {
        ...
        return SMGPSubmitRespMessage.bcd2Str(getMsgId());
    }
