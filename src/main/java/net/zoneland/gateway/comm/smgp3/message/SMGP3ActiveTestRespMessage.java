...
public class SMGP3ActiveTestRespMessage extends SMGP3Message
{

    public SMGP3ActiveTestRespMessage()
        throws IllegalArgumentException
    {
        int len = 12;
        super.buf = new byte[len];
        TypeConvert.int2byte(len, super.buf, 0);
        TypeConvert.int2byte(RequestId.ACTIVETEST_RESP, super.buf, 4);
    }

    public SMGP3ActiveTestRespMessage(byte buf[])
        throws IllegalArgumentException
    {
    ...
    {
        return RequestId.ACTIVETEST_RESP;
    }
}
