...
public class SMGP3ExitRespMessage extends SMGP3Message
{

    public SMGP3ExitRespMessage()
        throws IllegalArgumentException
    {
        int len = 12;
        super.buf = new byte[len];
        TypeConvert.int2byte(len, super.buf, 0);
        TypeConvert.int2byte(RequestId.EXIT_RESP, super.buf, 4);
    }

    public SMGP3ExitRespMessage(byte buf[])
        throws IllegalArgumentException
    {
